...
-   [TEST OK](#test-ok)
-   [FAST](#fast)
-   [STARTER GRAPHQL/MONGODB BACKEND](#starter-graphqlmongodb-backend)
-   [STARTER GRAPHQL/MONGODB FRONTEND](#starter-graphqlmongodb-frontend)
-   [CONVERT MYSQL TO MONGO](#convert-mysql-to-mongo)
-   [CONCEPTS](#concepts)
