...
-   [IOS](#ios)
    ...
    -   [STARTER / SEED / EXAMPLES](#starter--seed--examples)
    -   [LIBS: IONIC](#libs-ionic)
    -   [LIBS: CAPACITOR](#libs-capacitor)
    -   [LIBS: OTHERS](#libs-others)
    -   [PWA](#pwa)
    -   [NEWS](#news)
    -   [ALLS](#alls)
    -   [MOCK CORDOVA PLUGINS](#mock-cordova-plugins)
    -   [FORMS](#forms)
    ...
    -   [UPLOAD IMAGE HELPER](#upload-image-helper)
    -   [UPLOAD IMAGE NATIVE](#upload-image-native)
    -   [LAZY HELPER](#lazy-helper)
    -   [RATE APP FUN](#rate-app-fun)
